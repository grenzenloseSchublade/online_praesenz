...
def create_colormap(palette_name):
    ...
    color_palettes = {
        ...
        'cyberpunk': ['#ff00ff', '#00ffc8', '#00ffff', '#ff00a0', '#7fff00'],
        'feuer': ['#000000', '#340000', '#800000', '#ff0000', '#ffff00'],
        'ozean': ['#000033', '#000066', '#0000ff', '#00ffff', '#ffffff'],
        'monochrom': ['#000000', '#333333', '#666666', '#999999', '#ffffff'],
        'regenbogen': ['#ff0000', '#ffff00', '#00ff00', '#00ffff', '#0000ff', '#ff00ff']
    }
